	...
	<div class="empty1">
		...
		<div class="table_box">
			...
			<div class="table_con2">
				...
				<div>				
					<div class="box3">
						<img class="img_box1" src="${dto.getBeans_img() }" width="300">				
					</div>
					
					<table class="table_1">
						<tr class="tr_1">
							<th style="width: 20%;">원두 번호</th>
							<td class="td_1">${dto.getBeans_num() }</td>
							<th>원두 이름</th>
							<td class="td_1">${dto.getBeans_name() }</td>						
						</tr>					
						<tr class="tr_1">
							<th>원두 맛</th>
							<td class="td_1">${dto.getBeans_taste() }</td>
							<th>원두 가격</th>
							<td class="td_1">${dto.getBeans_price() }</td>
						</tr>		
						<tr class="tr_1">
							<th>원두 평점</th>
							<td class="td_1">0 점</td><!-- 평점확인.. -->
							<th>원두 재고</th>
							<td class="td_1">${dto1.getBeans_count() } 개</td> 
						</tr>									
						<tr class="tr_1">
							<th>원두소개</th>
							<td class="td_1" colspan="4" style="padding: 30px 0px 30px 50px;">${dto.getBeans_intro() }</td>
						</tr>
					</table>		
				</div>	
			</div>
