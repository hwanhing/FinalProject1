	...
	<div class="first">
		...
		<div class="second">
			<div class="mb-3">
				  ...
				  <input type="text" class="form-control" id="exampleFormControlInput1" value="${dto1.getMember_id()}" readonly>
				  <div>
				...
				<div  class="mb-3">
						<h2>답변</h2>
					<div>
						  <textarea class="form-control" id="exampleFormControlTextarea1" rows="6" name="reply_cont">${dto.getReply_cont() }</textarea>
