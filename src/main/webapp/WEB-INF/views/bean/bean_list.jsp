        ...
        <div class="list_box">
        	...
        	<div class="con1">
        		...
        		<div class="con_info">
        			...
        			<%-- 찜 버튼 --%>
       				<button type="button" id="heart_btn" class="heart_btn">
 						<svg focusable="false" viewBox="0 0 24 24" class="pip-svg-icon pip-btn__icon" aria-hidden="true" onclick="${i.getBeans_num()}">
		...
		$.ajax({
			...
			success: function(data){
				...
				if(data == 1){
					...
					$("#heart_border").attr("d", "M19.205 5.599c.9541.954 1.4145 2.2788 1.4191 3.6137 0 3.0657-2.2028 5.7259-4.1367 7.5015-1.2156 1.1161-2.5544 2.1393-3.9813 2.9729L12 20.001l-.501-.3088c-.9745-.5626-1.8878-1.2273-2.7655-1.9296-1.1393-.9117-2.4592-2.1279-3.5017-3.5531-1.0375-1.4183-1.8594-3.1249-1.8597-4.9957-.0025-1.2512.3936-2.5894 1.419-3.6149 1.8976-1.8975 4.974-1.8975 6.8716 0l.3347.3347.336-.3347c1.8728-1.8722 4.9989-1.8727 6.8716 0z")
